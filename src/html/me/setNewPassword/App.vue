<template>
  <div id="login">
    ...
    <header class="headerNavFixed">
      ...
      ></div>
      <div class="nvtt" style="width:70%">设置新密码</div>
    </header>
    <!-- 正文 -->
      ...
      <div class="wrapper">
        <div class="defaultLogin">
          <div class="defaultUser">
            <input type="password" name placeholder="请输入新密码，不少于8位" v-model="newPassword" />
            <img
          ...
          <div class="defaultUser">
            <input type="password" name placeholder="请再次输入密码" v-model="newAgainPassword" />
            <img
              src="data:image/png;base64,"
            />
          </div>
          <div class="loginBox" @click="landing">完成</div>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    landing() {
      ...
      that.axios({
        ...
        data: qs.stringify({
          verification:that.verification,//验证码
