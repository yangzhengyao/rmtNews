<template>
  <div id="servicelist">
    <header class="com_header headerNavFixed" style="background:#fff;line-height: 0.4rem; ">
      ...
      <div class="nvtt" style="color:#000;line-height: .88rem;">铁门关大酒店</div>
    ...
    <div class="servercont" :class="iphonexPadding ? 'changetoplist':''">
      <!-- <iframe class="my_frame" v-show="newindex==0" id="iframepages" frameborder="0" height="100%" scrolling='no'
        src="https://touch.qunar.com/hoteldetail?seq=bayinguoleng_2667&checkInDate=2019-01-25&checkOutDate=2020-07-26&fromForLog="
        style="width:1px; min-width:100%; *width:100%;height:24rem!important;"></iframe> -->

      <!-- <iframe class="my_frame" v-show="newindex==1" id="iframepages" frameborder="0" height="100%" scrolling='no'
        ...
        style="width:1px; min-width:100%; *width:100%;height:42rem!important;"></iframe> -->
      <iframe class="my_frame" v-show="newindex==0" id="iframepages" frameborder="0" height="100%" scrolling='no' src="
    https://m.ctrip.com/webapp/hotel/hoteldetail/6034046.html?atime=20190725&days=1&shareid=NjAzNDA0Nnxob3RlbF9pbm5fZGV0YWlsfDh8MjAxOTA3MjUxMzA5MDE=&uid=3C4951AD689B88BC9CE11BE3A9BFC55428E4275125A2A8AFFC81696A5E2D290E&s_guid=E615F3B4-7B25-4405-9578-5FFEEF9D20B0
    " style="width:1px; min-width:100%; *width:100%;height:50rem!important;"></iframe>
      <iframe class="my_frame" v-show="newindex==1" id="iframepages" frameborder="0" height="100%" scrolling='no' src="
  http://hotel.elong.com/91673061/
  " style="width:1px; min-width:100%; *width:100%;height:34rem!important;"></iframe>
    </div>
  </div>
</template>
<script>
