<template>
  <div id="newCommunity">
    <!-- <header class="com_header headerNavFixed">
      ...
      <div class="nvtt">{{apis.getTheme() =='dongpo'?'报料':'社区'}}</div>
      <div class="nvbt iabout" style @click="actionSheetType" v-if="getStorge">
        <img src="../me/img/add.png" alt v-if="apis.getTheme() !='dongpo'"/>
        <img src="../me/img/dongpoadd.png" alt  v-else style="height:0.4rem"/>
      </div>
    </header> -->
    <!-- 头部 -->
    <home-header />
