<template>
    <swiper :options="swiperOption" class="swiper-box swiper-box-news swiper-box-community" ref="wenlvSwiper" :class="{isIOS: $store.state.device == 'ios'}">
