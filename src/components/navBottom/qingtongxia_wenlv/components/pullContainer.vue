...
export default {
    ...
    methods: {
        ...
        init () {
            if ( (this.indexActive === this.type && !(this.contentJson.length > 0)) || (this.indexActive === apis.theme.wenlv.columnId.lvyoujingqu && this.childTabActive == this.type  && !(this.contentJson.length > 0)) ) {
