...
export default {
    ...
    methods: {
        ...
        init () {
            if ( this.indexActive === this.type && !(this.contentJson.length > 0)  || ( this.indexActive === '5d24707be4b09067cf75240c' ) && this.childTabActive == this.type) {
            ...
            .then(res => {
                ...
                res.data[0].list.forEach(function (item,i) {
                    tempArr.push({
                        ...
                        audio: item.stroyType=='AUDIO'?item.video_url:false, // 音频
