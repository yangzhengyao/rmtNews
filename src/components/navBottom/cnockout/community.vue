<template>
  <div id="newCommunity">
    <header class="com_header headerNavFixed">
      ...
      <div class="nvtt">爆料</div>
      <div class="nvbt iabout"  @click="urlTipOffRelease">
          <img src="../me/img/dongpoadd.png" alt  style="height:0.4rem"/>
      </div>
      <div class="activtyall">
        <div class="activty-nav">
          <ul>
            <li>
              <span  @click="urlTipOffRelease">我要爆料</span>
            </li>
            <li>
              <span  @click="mytipOff">我的爆料</span>
            </li>
          </ul>
        </div>
      </div>
...
<script>
import tipOffS from "./children/tipOff";
