...
export default {
  ...
  computed: {
    ...mapGetters("wenchang_qiaoshequ", ["indexActive", "activeIndex", "indexColumn"])
  },
  watch: {
    indexActive() {
      this.slideTo();
  ...
  methods: {
    ...mapMutations("hcWenlv", ["set_indexActive", "set_indexSwiper"]),
    ...mapActions("hcWenlv", [
  ...
  mounted() {
    let that = this;
    this.hcwenlv_child_listItem_data().then(res => {
