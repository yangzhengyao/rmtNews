<template>
  ...
  >
    ...
    >
      ...
      <!-- listItem -->
      <!-- <list-item :itemJson="contentJson" :isHaixia="isHaixia" v-if="contentJson.length > 0"></list-item> -->
...
export default {
    ...
    methods: {
        ...
        init () {
            ...
            if ( (this.indexActive === this.type && !(this.contentJson.length > 0)) || (this.indexActive === apis.theme.hclv.columnId.lvyoujingqu && this.childTabActive == this.type  && !(this.contentJson.length > 0)) ) {
        ...
        loadTopAjax () {
            ...
            var that=this;
            var uuid=(this.indexActive==apis.theme.hclv.columnId.lvyoujingqu)?this.type:null
            this.classPage=0
            // this.loading = true
        ...
        loadBottomAjax () {
            var that=this;
            var uuid=this.type==apis.theme.hclv.columnId.lvyoujingqu?apis.theme.hclv.columnId.lvyoujingqu:null
