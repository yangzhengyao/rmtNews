      ...
      convenient: [
        {
          ...
          name: "普洱市<br>人民医院",
          src: "http://www.pesrmyy.com/"
        },
        {
          icon: require("../images/yygh.png"),
          name: "普洱市<br>预约挂号",
          src: "http://wapyyk.39.net/puer/"
        },
        {
        ...
        },
        {
          ...
          name: "天气预报",
          src: "http://wx.weather.com.cn/mweather/101290909.shtml#1"
        },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/threads/mobilelist?fid=4322",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "市长信箱",
          src: "http://xfservice.yn.gov.cn/mailbox/wyxx.do?type=1",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "县政务<br>服务中心",
          src: "http://220.163.118.118/index.html?siteId=8553",
          marker: true
        },
        {
