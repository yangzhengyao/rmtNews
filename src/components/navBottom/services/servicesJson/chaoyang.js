      ...
      convenient: [
        {
          ...
          name: "朝阳县<br>人民医院",
          src: "http://www.lnscyxrmyy.com/"
        },
        {
          icon: require("../images/yygh.png"),
          name: "朝阳县<br>预约挂号",
          src: "http://wapyyk.39.net/chaoyang2/"
        },
        {
        ...
        },
        {
          ...
          name: "天气预报",
          src: "https://baidu.weather.com.cn/mweather/101071201.shtml"
        },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/forum/list?fid=8",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "市长信箱",
          src: "http://www.zgcy.gov.cn/ZGCY/hdjl/005001/",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "县政务<br>服务中心",
          src: "http://www.cyx.gov.cn/index.asp",
          marker: true
        },
        {
