      ...
      convenient: [
        {
          ...
          name: "华宁县<br>人民医院",
          src: "http://www.hnxrmyy.cn/"
        },
        {
          icon: require("../images/yygh.png"),
          name: "玉溪市<br>预约挂号",
          src: "http://wapyyk.39.net/yuxi/"
        },
        {
        ...
        },
        {
          ...
          name: "天气预报",
          src: "https://baidu.weather.com.cn/mweather/101290705.shtml"
        },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/threads/list?fid=4287",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "县长信箱",
          src: "http://www.huaning.gov.cn/yxgovfront/guestbookWrite.jspx?_s_=24",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "县政务<br>服务中心",
          src: "http://ynzwfw.yn.gov.cn/index.html?siteId=3947",
          marker: true
        },
        {
