    ...
    dataAI: [
      ...
      convenient: [
        ...
        },
        {
          ...
          name: "天气预报",
          src: "http://wx.weather.com.cn/mweather/101290701.shtml#1"
        },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/forum/list?fid=433",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "市长信箱",
          src: "http://m.yuxi.gov.cn/zmhd/",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "市政务<br>服务中心",
          src: "http://ynzwfw.yn.gov.cn/index.html?siteId=3615",
          marker: true
        },
        {
