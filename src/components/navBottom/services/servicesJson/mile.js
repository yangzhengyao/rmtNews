const servicesJson = {
    dataAI: [
      ...
      convenient: [
        {
          ...
          name: "弥勒市<br>第一医院",
          src: "http://www.mlsrmyy.cn/"
        },
        {
          icon: require("../images/yygh.png"),
          name: "红河州<br>预约挂号",
          src: "http://wapyyk.39.net/hhhnzyzzzz/"
        },
        {
        ...
        
        {
          ...
          name: "公积金查询",
          src:
            "http://www.hhgjj.com/website/net-map.html"
        },
        {
        ...
        },
        {
          ...
          name: "天气预报",
          src: "http://wx.weather.com.cn/mweather/101290304.shtml#1"
        },
        // {
        //   icon: require("../images/gjcx.png"),
        //   name: "公交查询",
        //   src: "http://bus.mapbar.com/beijing/"
        // },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/threads/list?fid=4345",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "市长信箱",
          src: "http://www.mile.hh.gov.cn/hdjl_13851/",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "市政务<br>服务中心",
          src: "http://ynzwfw.yn.gov.cn/index.html?siteId=11176",
          marker: true
        },
        {
      ...
      banner:[
        {
          icon: require("../../tiemenguan_zhibo/images/ico_xcy.png"),
          name: "现场云",
          src: "https://live.xinhuaapp.com/xcy/userhome.html?orgId=155609315556260",
          id:'5d5524f6e4b08f7738231eb8',
          marker: true
        },
        {
          icon: require("../../tiemenguan_zhibo/images/ico_tgb.png"),
          name: "蜻蜓FM",
          src: "https://m.qingting.fm/channels/5022531/?qtsrc=appshare_weixin",
          id:'5d5524f6e4b08f7738231eb8',
          marker: true
        },
        {
