const servicesJson = {
  ...
  dataAI: [
    ...
    {
      icon: require("../images/wenchang_gbdst.jpg"),
      name: "文昌市广播电视台",
      namecont:"文昌市广播电视台",
      path: "service/tianqi",
      menu: "Robot"
    ...
    {
      icon: require("../images/wenchangwang.jpg"),
      name: "文昌网",
      namecont:"文昌网",
      path: "service/tianqi",
      menu: "Robot"
     ...
     {
      icon: require("../images/wenchang_rmw.jpg"),
      name: "文昌人民政府网",
      namecont:"文昌人民政府网",
      path: "service/tianqi",
      menu: "Robot"
  ...
  convenient: [
    {
      ...
      name: "文昌市人民医院",
      src: "http://www.wenchangyiyuan.cn/"
    },
    {
      icon: require("../images/yygh.png"),
      name: "文昌市预约挂号",
      src: "http://wapyyk.39.net/wenchang/"
    },
    {
      icon: require("../images/jidi.png"),
      name: "文昌航天发射基地",
      src:'http://m.dianping.com/shop/66453180?source=pc_jump',
    }, {
      icon: require("../images/gongyuan.png"),
      name: "文昌航天主题公园",
      src:'http://m.dianping.com/shop/66453180?source=pc_jump',
    },
    {
    ...
    },
    {
      ...
      name: "天气预报",
      src: "http://wx.weather.com.cn/mweather/101310212.shtml#1"
    },
    {
      icon: require("../images/gjcx.png"),
      name: "公交查询",
      src: "http://www.wenchang.ccoo.cn/bus/"
    },
    {
  ...
  zhengwu: [
    {
      ...
      name: "地方领导留言",
      src: "http://liuyan.people.com.cn/forum/list?fid=32",
      marker: true
    },
    {
      icon: require("../images/xinxiang.png"),
      name: "市长信箱",
      src: "http://xf.hainan.gov.cn/index.php?m=member&c=index&a=login&orgcode=469005000013&type=600",
      marker: true
    },
    {
      icon: require("../images/nxzwfww.png"),
      name: "市政务服务中心",
      src: "http://wenchang.hainan.gov.cn/wenchang/bsfw/fw.shtml",
      marker: true
    },
    {
