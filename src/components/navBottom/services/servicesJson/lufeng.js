      ...
      convenient: [
        {
          ...
          name: "禄丰县<br>人民医院",
          src: "http://www.lfxrmyy.com/"
        },
        {
          icon: require("../images/yygh.png"),
          name: "楚雄州<br>预约挂号",
          src: "http://wapyyk.39.net/cxyzzzz/"
        },
        {
        ...
        },
        {
          ...
          name: "天气预报",
          src: "https://baidu.weather.com.cn/mweather/101290808.shtml"
        },
        {
      ...
      zhengwu: [
        {
          ...
          name: "地方领导留言",
          src: "http://liuyan.people.com.cn/forum/list?fid=427",
          marker: true
        },
        {
          icon: require("../images/xinxiang.png"),
          name: "市长信箱",
          src: "http://xfservice.yn.gov.cn/gateway/indexIframe.do?code=532331000000&url=/anonymous/petitionDept.do&type=5#",
          marker: true
        },
        {
          icon: require("../images/nxzwfww.png"),
          name: "市政务<br>服务中心",
          src: "http://www.ynlf.gov.cn/zmhd.jsp?urltype=tree.TreeTempUrl&wbtreeid=1003",
          marker: true
        },
        {
