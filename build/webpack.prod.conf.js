...
const theme = packageConfig.theme
...
//           pathname = tmp[0] + '/' + tmp[1] + '/' + basename // ��ȷ���js��html��·��
//         }
...
// console.log('proWebpackConfig ' + JSON.stringify(webpackConfig))
...
//     // template: pages[pathname],   // ģ��·��
//     template: 'src/html/index.html',   // ģ��·��
