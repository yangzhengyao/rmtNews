    ...
    actions: {
        ...
        async get_indexColumn_data({ commit, state, dispatch }) {
            ...
            // } else {
                ...
                let data = await fetch('post', 'classID', {appInfoId: apis.theme.api.appInfoId, parentId: apis.theme.wenlv.parentId.qinqiang}
                // {
                //     type: 'column',
                //     //获取两岸一家亲子栏目
                ...
                console.log(...state.indexColumn,'jianguxunliang ');
            // }
