...
export default {
    ...
    state: {
        ...
        // }],
        indexActive: '5d5b7959e4b07bac64e0d138',          // active的栏目
    ...
    actions: {
        ...
        async get_indexColumn_data({ commit, state, dispatch }) {
            ...
            // } else {
                ...
                let data = await fetch('post', 'classID',{appInfoId: apis.theme.api.appInfoId,parentId: '5d5b78b9e4b07bac64e0d122'}
                //  {
                //     type: 'column',
                //     //获取两岸一家亲子栏目
                //     parentId: '5d5b78b9e4b07bac64e0d122'
                // }
                , params)
