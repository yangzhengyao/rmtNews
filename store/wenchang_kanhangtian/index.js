...
export default {
    ...
    state: {
        ...
        // }],
        indexActive: '5d5b7977e4b07bac64e0d13e',          // active的栏目
    ...
    actions: {
        ...
        async get_indexColumn_data({ commit, state, dispatch }) {
            ...
            // } else {
                ...
                let data = await fetch('post', 'classID',{appInfoId: apis.theme.api.appInfoId,parentId:'5d5b78c2e4b07bac64e0d124'}
                //  {
                //     type: 'column',
                //     //获取两岸一家亲子栏目
                //     parentId: '5d5b78c2e4b07bac64e0d124'
                // }
                , params)
                ...
                data.data.forEach(function (item, i) {
                    if( apis.theme.api.appName == 'haicang' ){
